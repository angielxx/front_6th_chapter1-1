(function(){let e=document.createElement(`link`).relList;if(e&&e.supports&&e.supports(`modulepreload`))return;for(let e of document.querySelectorAll(`link[rel="modulepreload"]`))n(e);new MutationObserver(e=>{for(let t of e){if(t.type!==`childList`)continue;for(let e of t.addedNodes)e.tagName===`LINK`&&e.rel===`modulepreload`&&n(e)}}).observe(document,{childList:!0,subtree:!0});function t(e){let t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),e.crossOrigin===`use-credentials`?t.credentials=`include`:e.crossOrigin===`anonymous`?t.credentials=`omit`:t.credentials=`same-origin`,t}function n(e){if(e.ep)return;e.ep=!0;let n=t(e);fetch(e.href,n)}})();const e=`modulepreload`,t=function(e){return`/front_6th_chapter1-1/`+e},n={},r=function(r,i,a){let o=Promise.resolve();if(i&&i.length>0){let r=document.getElementsByTagName(`link`),s=document.querySelector(`meta[property=csp-nonce]`),c=s?.nonce||s?.getAttribute(`nonce`);function l(e){return Promise.all(e.map(e=>Promise.resolve(e).then(e=>({status:`fulfilled`,value:e}),e=>({status:`rejected`,reason:e}))))}o=l(i.map(i=>{if(i=t(i,a),i in n)return;n[i]=!0;let o=i.endsWith(`.css`),s=o?`[rel="stylesheet"]`:``,l=!!a;if(l)for(let e=r.length-1;e>=0;e--){let t=r[e];if(t.href===i&&(!o||t.rel===`stylesheet`))return}else if(document.querySelector(`link[href="${i}"]${s}`))return;let u=document.createElement(`link`);if(u.rel=o?`stylesheet`:e,o||(u.as=`script`),u.crossOrigin=``,u.href=i,c&&u.setAttribute(`nonce`,c),document.head.appendChild(u),o)return new Promise((e,t)=>{u.addEventListener(`load`,e),u.addEventListener(`error`,()=>t(Error(`Unable to preload CSS for ${i}`)))})}))}function s(e){let t=new Event(`vite:preloadError`,{cancelable:!0});if(t.payload=e,window.dispatchEvent(t),!t.defaultPrevented)throw e}return o.then(e=>{for(let t of e||[]){if(t.status!==`rejected`)continue;s(t.reason)}return r().catch(s)})};var i=class e{constructor(t,n){this.routes=t,this.rootElement=n,this.queryParams={},this.params={},e.instance=this,this.init()}init(){window.addEventListener(`popstate`,()=>{this.handleRouteChange()}),this.handleRouteChange()}handleRouteChange(){this.parseQueryParams(),this.render()}render(){console.log(`BASE`,Y),console.log(`currentPath`,this.getCurrentPath());let e=this.getCurrentRoute();this.currentInstance&&this.currentInstance.destroy&&this.currentInstance.destroy();let t=e.component;this.currentInstance=new t(this.rootElement,{params:this.params,query:this.queryParams})}navigate(e,t=!1){let n=this.normalizePath(e);t?window.history.replaceState(null,``,n):window.history.pushState(null,``,n),this.handleRouteChange()}normalizePath(e){if(e.includes(`?`)){let[t,n]=e.split(`?`),r=t.startsWith(`/`)?t:`/${t}`,i=Y===`/`?r:`${Y.slice(0,-1)}${r}`;return`${i}?${n}`}let t=e.startsWith(`/`)?e:`/${e}`;return Y===`/`?t:`${Y.slice(0,-1)}${t}`}getCurrentPath(){let e=window.location.pathname;if(Y!==`/`){let t=Y.slice(0,-1);if(e.startsWith(t))return e.slice(t.length)||`/`}return e}parseQueryParams(){let e={...this.queryParams};this.queryParams={};let t=new URLSearchParams(window.location.search);for(let[e,n]of t)this.queryParams[e]=n;let n=JSON.stringify(e)!==JSON.stringify(this.queryParams);n&&this.dispatchQueryParamsChange()}getCurrentRoute(){let e=this.getCurrentPath(),t=this.routes.find(t=>t.path===e);if(t)return this.params={},t;let n=this.routes.find(t=>{if(t.path.includes(`:`)){let n=t.path.split(`/`),r=e.split(`/`);if(n.length!==r.length)return!1;let i=n.every((e,t)=>e.startsWith(`:`)?!0:e===r[t]);if(i)return this.params={},n.forEach((e,t)=>{if(e.startsWith(`:`)){let n=e.substring(1);this.params[n]=r[t]}}),!0}return!1});if(n)return n;let r=this.routes.find(e=>e.path===`*`);return r||null}getCurrentComponent(){let e=this.getCurrentRoute();return e.component}getParams(e){return e?this.params[e]:{...this.params}}setParam(e,t){this.params[e]=t}setParams(e){this.params=e}getQueryParams(e){return e?this.queryParams[e]:{...this.queryParams}}setQueryParam(e,t){t==null||t===``?delete this.queryParams[e]:this.queryParams[e]=t,this.updateURL()}setQueryParams(e){Object.keys(this.queryParams).forEach(e=>{delete this.queryParams[e]}),Object.entries(e).forEach(([e,t])=>{t!=null&&t!==``&&(this.queryParams[e]=t)}),this.updateURL()}updateURL(){let e=new URL(window.location),t=this.getCurrentPath(),n=Y===`/`?t:`${Y.slice(0,-1)}${t}`;e.pathname=n,e.search=``,Object.entries(this.queryParams).forEach(([t,n])=>{n!=null&&n!==``&&e.searchParams.set(t,n.toString())}),window.history.replaceState(null,``,e.toString()),this.dispatchQueryParamsChange()}dispatchQueryParamsChange(){let e=new CustomEvent(`queryParamsChange`,{detail:{queryParams:{...this.queryParams}}});window.dispatchEvent(e)}static getInstance(){return e.instance||null}};async function a(e={}){let{limit:t=20,search:n=``,category1:r=``,category2:i=``,sort:a=`price_asc`}=e,o=e.current??e.page??1,s=new URLSearchParams({page:o.toString(),limit:t.toString(),...n&&{search:n},...r&&{category1:r},...i&&{category2:i},sort:a}),c=await fetch(`/api/products?${s}`);return await c.json()}async function o(e){let t=await fetch(`/api/products/${e}`);return await t.json()}async function s(){let e=await fetch(`/api/categories`);return await e.json()}function c(){return`<footer class="bg-white shadow-sm sticky top-0 z-40">
  ...
  >
    ...
    <div class="p-3">
  ...
  </div>`}const N=10,P=(e,t)=>{let n,r=0;return function(...i){let a=Date.now();a-r>t?(e.apply(this,i),r=a):(clearTimeout(n),n=setTimeout(()=>{e.apply(this,i),r=Date.now()},t-(a-r)))}};var F=class extends l{setup(){this.prevFilterState=null,this.throttledScrollHandler=P(this.handleInfiniteScroll.bind(this),100),this.restoreScrollPosition=this.restoreScrollPosition.bind(this),this.handleProductClick=this.handleProductClick.bind(this),this.handleQueryParamsChange=this.handleQueryParamsChange.bind(this),this.unsubscribe=v.subscribe(()=>{console.log(`homeState changed`);let{limit:e,sort:t,search:n,category1:r,category2:i}=E(),a=v.getState(),o={page:a.products.pagination.page,limit:e,search:n,category1:r,category2:i,sort:t};this.shouldFetchInitialProducts(o)&&this.fetchInitialProducts(),this.render(),this.setEvent(),this.mounted(),this.prevFilterState=o})}handleQueryParamsChange(){v.setState({products:{pagination:{...v.getState().products.pagination,page:d}}})}setEvent(){this.$target.querySelectorAll(`.product-card img`).forEach(e=>{e.addEventListener(`click`,this.handleProductClick)}),this.handleAddToCart(),window.addEventListener(`queryParamsChange`,this.handleQueryParamsChange),window.addEventListener(`scroll`,this.throttledScrollHandler)}cleanup(){this.$target.querySelectorAll(`.product-card img`).forEach(e=>{e.removeEventListener(`click`,this.handleProductClick)}),window.removeEventListener(`queryParamsChange`,this.handleQueryParamsChange),window.removeEventListener(`scroll`,this.throttledScrollHandler),this.unsubscribe&&this.unsubscribe()}shouldFetchInitialProducts(e){if(!this.prevFilterState)return!0;let t=[`page`,`search`,`category1`,`category2`,`sort`,`limit`];return t.some(t=>this.prevFilterState[t]!==e[t])}handleProductClick(e){e.stopPropagation();let{navigate:t}=C(),n=e.target.closest(`.product-card`);if(n){let e=n.dataset.productId;this.saveScrollPosition(),t(`/product/${e}`)}}saveScrollPosition(){let e={scrollTop:window.scrollY,timestamp:Date.now()};sessionStorage.setItem(`productListScrollPosition`,JSON.stringify(e))}restoreScrollPosition(){let e=sessionStorage.getItem(`productListScrollPosition`);if(e)try{let{scrollTop:t,timestamp:n}=JSON.parse(e);Date.now()-n<30*60*1e3&&window.scrollTo(0,t),sessionStorage.removeItem(`productListScrollPosition`)}catch(e){console.error(`스크롤 위치 복원 실패:`,e)}}async fetchMoreProducts(){let e=v.getState(),{isMoreProductsLoading:t,pagination:{page:n}}=e.products,{limit:r,sort:i,search:o,category1:s,category2:c}=E();if(!t)try{v.setState({products:{...e.products,isMoreProductsLoading:!0}});let t={page:n+1,limit:r,search:o,category1:s,category2:c,sort:i},{products:l,pagination:u}=await a(t);v.setState({products:{...v.getState().products,isMoreProductsLoading:!1,list:[...v.getState().products.list,...l],pagination:{...u,page:n+1},productListMode:g.INFINITE_SCROLL}})}catch(e){throw console.error(`상품 추가 로딩 실패:`,e),v.setState({products:{...v.getState().products,isMoreProductsLoading:!1}}),e}}async fetchInitialProducts(){let e=v.getState(),{isProductsLoading:t}=e.products,{limit:n,sort:r,search:i,category1:o,category2:s}=E();if(t)return;v.setState({products:{...e.products,isProductsLoading:!0}});let c={page:d,limit:n,search:i,category1:o,category2:s,sort:r},{products:l,pagination:u}=await a(c);v.setState({products:{isProductsLoading:!1,list:l,total:u.total,pagination:u}})}async handleInfiniteScroll(){let{isProductsLoading:e,isMoreProductsLoading:t,pagination:n}=v.getState().products;if(e||t)return;let r=window.scrollY,i=document.body.scrollHeight,a=window.innerHeight,o=r+a>=i-N;if(o){let{page:e,total:t,limit:r}=n,i=Math.ceil(t/r);if(e>=i)return;try{await this.fetchMoreProducts()}catch(e){console.error(`무한스크롤 로딩 에러:`,e),v.setState({products:{...v.getState().products,isMoreProductsLoading:!1}})}}}mounted(){setTimeout(()=>{this.restoreScrollPosition()},100)}handleAddToCart(){let{cart:e,products:t}=v.getState(),n=document.querySelectorAll(`.add-to-cart-btn`);n.length&&n.forEach(n=>{n.addEventListener(`click`,n=>{n.stopPropagation();let r=n.target.dataset.productId,i=t.list.find(e=>e.productId===r),a=e.items.some(e=>e.productId===r);a||v.setState({cart:{items:[...e.items,{...i,quantity:1}]}})})})}appendProductsToDOM(e){let t=document.querySelector(`#products-grid`);t&&(e.forEach(e=>{let n=M(e),r=document.createElement(`div`);r.innerHTML=n;let i=r.firstElementChild;i&&t.appendChild(i)}),this.setEvent())}loadingTemplate(){return` <div class="grid grid-cols-2 gap-4">
      <div
    ...
    </div>`}template(){let{products:{list:e,total:t,isProductsLoading:n,isMoreProductsLoading:r,pagination:i}}=v.getState();if(n)return this.loadingTemplate();let{page:a,limit:o}=i,s=Math.ceil(t/o),c=a<s;return` <div>
      <!-- 상품 개수 정보 -->
      ...
      <!-- 무한스크롤 로딩 상태 -->
      ${r?`<div class="grid grid-cols-2 gap-4 mb-6">
      ...
      <!-- 완료 메시지 -->
      ${c?``:`<div class="text-center py-4 text-sm text-gray-500">모든 상품을 확인했습니다</div>`}
    </div>`}};const I={HEADER:`header`,FILTER:`filter`,PRODUCT_LIST:`productList`};var L=class extends l{setup(){this.unsubscribe=v.subscribe(()=>{let e=i.getInstance(),t=e?.getCurrentPath();t===`/`&&(this.render(),this.setEvent(),this.mounted())}),this.fetchCategories()}async fetchCategories(){let e=v.getState(),{isCategoryLoading:t,categoryList:n}=e.categories,r=n&&(Array.isArray(n)?n.length>0:Object.keys(n).length>0);if(r||t)return;v.setState({categories:{...e.categories,isCategoryLoading:!0}});let i=await s();v.setState({categories:{categoryList:i,isCategoryLoading:!1}})}mounted(){let e=document.querySelector(`#filter-container`),t=document.querySelector(`#product-list-container`),n=document.querySelector(`#header-container`);if(this.child.get(I.HEADER)){let e=this.child.get(I.HEADER);e.$target=n,e.render()}else{let e=new y(n);this.addChild(e,I.HEADER)}if(this.child.get(I.FILTER)){let t=this.child.get(I.FILTER);t.$target=e,t.render()}else{let t=new A(e);this.addChild(t,I.FILTER)}if(this.child.get(I.PRODUCT_LIST)){let e=this.child.get(I.PRODUCT_LIST);e.$target=t,e.render()}else{let e=new F(t);this.addChild(e,I.PRODUCT_LIST)}}template(){return`
    ...
    `}};function R(e=`상품 정보를 불러오는 중...`){return`<div class="w-full h-full min-h-screen flex items-center justify-center">
  ...
  </div>`}var z=class extends l{setup(){this.unsubscribe=v.subscribe(()=>{this.render(),this.setEvent(),this.mounted()})}template(){let{items:e}=v.getState().cart,t=e.reduce((e,t)=>e+t.quantity,0),n=e.length===0||t===0;return`
    ...
    </div>`}template(){let{product:e,relatedProducts:t,isLoading:n,isRelatedProductsLoading:r}=this.state,{productId:i,image:a,title:o,lprice:s,stock:l,description:u,rating:d,reviewCount:f}=e;return n||r?R():`<div class="min-h-screen bg-gray-50">
    ...
    </main>`}setEvent(){this.$target.addEventListener(`click`,e=>{e.target.matches(`a[data-link]`)&&(e.preventDefault(),window.history.pushState({},``,`/`),window.dispatchEvent(new Event(`popstate`)))})}};const q=[{path:`/`,component:L},{path:`/product/:id`,component:G},{path:`*`,component:K}];function J(){new i(q,document.getElementById(`root`))}const Y=`/front_6th_chapter1-1/`,X=()=>r(async()=>{let{worker:e}=await import(`./browser-Dg-BbG0-.js`);return{worker:e}},[]).then(({worker:e})=>e.start({onUnhandledRequest:`bypass`,serviceWorker:{url:`${Y.slice(0,-1)}/mockServiceWorker.js`}}));function Z(){J()}X().then(Z);export{Y as b};